      ...
      <div style={styles.body}>
        ...
        <div style={styles.footer}>
          ...
          <button
            style={{
              ...styles.addButton,
              backgroundColor: inCart ? "#16a34a" : "#111",
            }}
...
const styles = {
  ...
  typeBadge: {
    ...
    color: "#333", letterSpacing: "0.3px",
  },
  body: {
    padding: "1rem", display: "flex",
    flexDirection: "column", gap: "8px", flexGrow: 1,
  },
  header: {
    display: "flex", justifyContent: "space-between",
    alignItems: "baseline", gap: "8px",
  },
  name: { margin: 0, fontSize: "15px", fontWeight: "600", color: "#111" },
  price: { fontSize: "15px", fontWeight: "700", color: "#111", whiteSpace: "nowrap" },
  description: { margin: 0, fontSize: "13px", color: "#666", lineHeight: "1.4" },
  footer: {
    display: "flex", justifyContent: "space-between",
    alignItems: "center", marginTop: "4px",
  },
  colorChip: { display: "flex", alignItems: "center", gap: "5px", fontSize: "12px", color: "#888" },
  colorDot: {
